...
activities = {
    ...
    "Basketball Club": {
        "description": "Learn and play basketball with teammates",
    ...
    "Music Ensemble": {
        "description": "Perform music and join a musical group",
        "schedule": "Tuesdays and Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 25,
        "participants": ["james@mergington.edu", "harmony@mergington.edu"]
    },
    "Robotics Club": {
...
def signup_for_activity(activity_name: str, email: str):
    ...
    # Validate if student is not  signed up
